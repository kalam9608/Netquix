...
const ShareModalTrainer = ({ isOpen, onClose, selectedClips, clips, isTrainer, userInfo, addTraineeClipInBookedSession, setSelectedClips }) => {
  return (
...
export default ShareModalTrainer;
